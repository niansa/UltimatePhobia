...
SaveFileManager::SaveFileManager()
    : es3Stream$$CreateStreamHook(GameHook::safeCreateOrPanic(
          saveFileManagerInfo, Il2Cpp::ES3Internal::ES3Stream::CreateStream_getPtr<System_IO_Stream_o *, ES3Settings_o *, int32_t>(),
...
ModInfo saveFileManagerInfo{"Save File Manager", false, []() { return std::make_unique<SaveFileManager>(); }, []() { SaveFileManager::loadIfNeeded(); }};
